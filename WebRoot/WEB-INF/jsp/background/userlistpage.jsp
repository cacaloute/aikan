	...
	<div class="member_table" style="width:1000px;margin:0px auto;background-color:#FAF4FF;">
        <table class="example" id="example">
            ...
            <tr class="trtile">
            	...
            	<th style="font-size:13px;background-color:#FFE4C4;">用户编号</th>
            	<th style="font-size:13px;background-color:#FFE4C4;">用户姓名</th>
            	<th style="font-size:13px;background-color:#FFE4C4;">用户密码</th>
                <th style="font-size:13px;background-color:#FFE4C4;">用户Email</th>
                <th style="font-size:13px;background-color:#FFE4C4;">用户性别</th>
                <th style="font-size:13px;background-color:#FFE4C4;">操作</th>
            </tr>
            </thead>
            <tbody><%int i = 1;%>
            <c:forEach items="${lists}" var="userT">
                <tr>
                    <td class="table_content"><%=i ++%></td>
                    <td class="table_content">${userT.userId}</td>
                    <td class="table_content">${userT.userName}</td>
                    <td class="table_content">${userT.userPassword}</td>
                    <td class="table_content">${userT.userEmail}</td>
                    <td class="table_content">${userT.userSex}</td>
                    <td class="table_content">
                        <div class="cell">
                            <a href="#" id="delete_button" class="update_button" name="${userT.userId}" style="color:red">删除</a>
                        </div>
                    </td>	
                </tr>      
            </c:forEach>
