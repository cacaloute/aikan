...
<body>
	...
	<div id="header">
		<div id="left">
		    <ul>
				...
				<li><a href="javascript:void(0);" id="type" class="menu">分类</a></li>
		...
		<div id="sec">
			<form id="searchForm" method="post" onsubmit="return false;">
                ...
                <input name="bookName" type="text" placeholder="书名 / 作者名" autocomplete="on" />
                <!-- class="big_search"-->
                <s id="btnSearch"></s>
            </form>
		</div>
	...
	<!--header结束-->
	<!-- hide开始 -->
		<div id="divhide" style="width:100%; height:100px;margin:0px auto;background-color:#DCDCDC">
			<!-- divmen开始 -->
			<div id="divman" style="width:100%;margin:15px auto;">
				<a href="javascript:void(0);"><span class="booktype" style="color:#696969">男生    ></span></a>
				<a href="javascript:void(0);" data="01"><span class="booktype">玄幻</span></a>
				<a href="javascript:void(0);" data="02"><span class="booktype">修真</span></a>
				<a href="javascript:void(0);" data="03"><span class="booktype">仙侠</span></a>
				<a href="javascript:void(0);" data="04"><span class="booktype">言情</span></a>
				<a href="javascript:void(0);" data="05"><span class="booktype">历史</span></a>
				<a href="javascript:void(0);" data="06"><span class="booktype">文字</span></a>
				<a href="javascript:void(0);" data="07"><span class="booktype">悬疑</span></a>
				<a href="javascript:void(0);" data="08"><span class="booktype">科普</span></a>
			</div>
			<!-- divmen结束 -->
			<!-- divwomen开始 -->
			<div id="divwomen" style="width:100%;;margin:5px auto;">
				<span class="booktype" style="color:#696969">女生    ></span>
				<a href="javascript:void(0);" data="10"><span class="booktype">玄幻</span></a>
				<a href="javascript:void(0);" data="20"><span class="booktype">修真</span></a>
				<a href="javascript:void(0);" data="30"><span class="booktype">仙侠</span></a>
				<a href="javascript:void(0);" data="40"><span class="booktype">言情</span></a>
				<a href="javascript:void(0);" data="50"><span class="booktype">历史</span></a>
				<a href="javascript:void(0);" data="60"><span class="booktype">文字</span></a>
				<a href="javascript:void(0);" data="70"><span class="booktype">悬疑</span></a>
				<a href="javascript:void(0);" data="80"><span class="booktype">科普</span></a>
			</div>
			<!-- divwomen结束 -->
			<!-- bookupdate开始 
			<div id="bookupdate">
			...
			<!-- hotbook开始 
			<div id="hotbook">
				<span class="booktype" style="color:#696969">排行榜    ></span>
				<a href="javascript:void(0);" data="1"><span class="booktype">男生爱看榜</span></a>
				<a href="javascript:void(0);" data="0"><span class="booktype">女生爱看榜</span></a>
			</div>
			 hotbook结束 -->
		</div>
		<!-- hide结束 -->
